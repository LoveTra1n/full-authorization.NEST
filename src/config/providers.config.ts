...
import {TypeOptions} from "../auth/provider/provider.contants";
import {GoogleProvider} from "../auth/provider/services/google.provider";
import {YandexProvider} from "../auth/provider/services/yande.provider";

export const getProviderConfig= async (configService:ConfigService):
    Promise<TypeOptions>=>({
